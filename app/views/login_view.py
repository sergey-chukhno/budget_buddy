...
class LoginView(ctk.CTkFrame):
    def __init__(self, master, login_callback, register_callback):
        ...
        # Email field
        self.email_label = ctk.CTkLabel(self.login_form_frame, text="Email:")
        ...
        # Password field
        self.password_label = ctk.CTkLabel(self.login_form_frame, text="Password:")
        ...
        # Error message label
        self.error_label = ctk.CTkLabel(self.login_form_frame, text="", text_color="red")
        ...
        self.register_label = ctk.CTkLabel(self.register_frame, text="Don't have an account?")
